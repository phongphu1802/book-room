...
abstract class AbstractService
{
    ...
    {
        $model = $this->model->where('user_uuid', auth()->user()->uuid)->firstOrFail($id);
    ...
    public function getCollectionByUserIdWithPagination($request)
    {
        $indexRequest = $this->getIndexRequest($request);
    ...
    public function findOneWhereOrFailByUserUuid($id)
    {
    ...
    {
        $model = $this->findOneWhereOrFailByUserUuid($id);
